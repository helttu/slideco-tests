...
class Tehostelevyt(CommonUtils):
    # Pagemodel timestamp: 20160121152450
    ...
    ALT_PANELMATERIAL_MUSTA_AALTO = (By.CSS_SELECTOR, u'img[alt="panelmaterial_musta_aalto"]') # x: 1268 y: 136 width: 76 height: 76
    ALT_PANELMATERIAL_TUMMA_KUKKA = (By.CSS_SELECTOR, u'img[alt="panelmaterial_tumma_kukka"]') # x: 1364 y: 136 width: 76 height: 76
    ALT_PANELMATERIAL_VAALEA_KUUKA = (By.CSS_SELECTOR, u'img[alt="panelmaterial_vaalea_kuuka"]') # x: 1460 y: 136 width: 76 height: 76
    ALT_PANELMATERIAL_VALKEA_AALTO = (By.CSS_SELECTOR, u'img[alt="panelmaterial_valkea_aalto"]') # x: 1368 y: 233 width: 76 height: 76
