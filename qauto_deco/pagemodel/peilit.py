...
class Peilit(CommonUtils):
    # Pagemodel timestamp: 20160121152221
    ...
    ALT_PANELMATERIAL_FROSTED_BRONZE = (By.CSS_SELECTOR, u'img[alt="panelmaterial_frosted_bronze"]') # x: 1268 y: 136 width: 76 height: 76
    ALT_PANELMATERIAL_FINLAND_HARMAA_PEILI = (By.CSS_SELECTOR, u'img[alt="panelmaterial_finland_harmaa_peili"]') # x: 1364 y: 136 width: 76 height: 76
    ALT_PANELMATERIAL_BRONZE_MIRROR = (By.CSS_SELECTOR, u'img[alt="panelmaterial_bronze_mirror"]') # x: 1460 y: 136 width: 76 height: 76
    ALT_PANELMATERIAL_FINLAND_KIRKAS_PEILI = (By.CSS_SELECTOR, u'img[alt="panelmaterial_finland_kirkas_peili"]') # x: 1368 y: 233 width: 76 height: 76
