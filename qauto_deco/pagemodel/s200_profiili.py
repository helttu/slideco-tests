...
class S200_profiili(CommonUtils):
    # Pagemodel timestamp: 20160121141438
    ...
    CONTENT_PROFILE_OPTIONS_STYLE_CONTAINER_LIST_S200_TER_SPROFIILI = (By.CSS_SELECTOR, u'.content-profile-options>.style-container-list>p') # x: 1240 y: 150 width: 352 height: 20
    CONTENT_PROFILE_OPTIONS_STYLE_CONTAINER_LIST_DATA_SET_SAVE_BINT_0 = (By.CSS_SELECTOR, u'.content-profile-options>.style-container-list>div.style.data-set-save-data-bint>.selection-checked>.icon') # x: 1242 y: 188 width: 352 height: 80
    CONTENT_PROFILE_OPTIONS_STYLE_CONTAINER_LIST_DATA_SET_SAVE_BINT = (By.CSS_SELECTOR, u'.content-profile-options>.style-container-list>div.style.data-set-save-data-bint>.selection-checked>.bg') # x: 1242 y: 188 width: 352 height: 80
    ALT_PANELPROFILE_WHITE = (By.CSS_SELECTOR, u'img[alt="panelprofile_white"]') # x: 1246 y: 188 width: 69 height: 69
    CONTENT_PROFILE_OPTIONS_STYLE_CONTAINER_LIST_DATA_SET_SAVE_BINT_1 = (By.CSS_SELECTOR, u'.content-profile-options>.style-container-list>div.style.data-set-save-data-bint>div.style-label') # x: 1322 y: 204 width: 272 height: 33
    ALT_PANELPROFILE_SILVER = (By.CSS_SELECTOR, u'img[alt="panelprofile_silver"]') # x: 1246 y: 285 width: 69 height: 69
    ALT_PANELPROFILE_SATIN_GOLD = (By.CSS_SELECTOR, u'img[alt="panelprofile_satin_gold"]') # x: 1246 y: 381 width: 69 height: 69
    ALT_PANELPROFILE_BLACK = (By.CSS_SELECTOR, u'img[alt="panelprofile_black"]') # x: 1246 y: 478 width: 69 height: 69
