...
class A103_profiili(CommonUtils):
    # Pagemodel timestamp: 20160121142042
    ...
    ALT_PANELPROFILE_GLOSS_WHITE_A103 = (By.CSS_SELECTOR, u'img[alt="panelprofile_gloss_white_a103"]') # x: 1246 y: 136 width: 69 height: 69
    ...
    ALT_PANELPROFILE_ANODISED_SILVER_A103 = (By.CSS_SELECTOR, u'img[alt="panelprofile_anodised_silver_a103"]') # x: 1246 y: 233 width: 69 height: 69
    ALT_PANELPROFILE_ANODISED_OLIVE_A103 = (By.CSS_SELECTOR, u'img[alt="panelprofile_anodised_olive_a103"]') # x: 1246 y: 329 width: 69 height: 69
    ALT_PANELPROFILE_SATIN_BLACK_A103 = (By.CSS_SELECTOR, u'img[alt="panelprofile_satin_black_a103"]') # x: 1246 y: 426 width: 69 height: 69
    ...
    def valitse_profiili_materiaali(self, parameters=None):
        if parameters[u'a103_materiaalit'] == u'valkea':
            self.click_element(self.ALT_PANELPROFILE_GLOSS_WHITE_A103)
        elif parameters[u'a103_materiaalit'] == u'alumiini':
            self.click_element(self.ALT_PANELPROFILE_ANODISED_SILVER_A103)
        elif parameters[u'a103_materiaalit'] == u'shampanja':
            self.click_element(self.ALT_PANELPROFILE_ANODISED_OLIVE_A103)
        elif parameters[u'a103_materiaalit'] == u'musta':
            self.click_element(self.ALT_PANELPROFILE_SATIN_BLACK_A103)
        else:
            self.click_element(self.ALT_PANELPROFILE_ANODISED_SILVER_A103)
