...
class S400_profiili(CommonUtils):
    # Pagemodel timestamp: 20160216132558
    ...
    ALT_PANELPROFILE_SILVER = (By.CSS_SELECTOR, u'img[alt="panelprofile_silver"]') # x: 1492 y: 151 width: 69 height: 69, tag: img, type: , name: None, form_id: , checkbox: ,href: None
    CONTENT_PROFILE_OPTIONS_STYLE_CONTAINER_LIST_DATA_SET_SAVE_BINT = (By.CSS_SELECTOR, u'.content-profile-options>.style-container-list>.data-set-save-data-bint>.style-label') # x: 1568 y: 167 width: 346 height: 33, tag: div, type: , name: None, form_id: , checkbox: ,href: 
    ELEMENT_BACK_TAKAISIN = (By.CSS_SELECTOR, u'.element-back>span') # x: 0 y: 785 width: 192 height: 23, tag: span, type: , name: None, form_id: , checkbox: ,href: None
    ...
    def click_link_element_back_takaisin(self, parameters=None): # AutoGen method
        self.click_element(self.ELEMENT_BACK_TAKAISIN)
